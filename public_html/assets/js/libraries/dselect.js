...
function dselect(el, option = {}) {
  ...
  const defaultSize = ''
  const search = true /*attrBool('search') || option.search || defaultSearch*/
  ...
  const searchInput = search ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="Rechercher" autofocus>` : ''
